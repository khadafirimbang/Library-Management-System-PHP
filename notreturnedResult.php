...
<head>
    ...
    <title>List of NotReturned Books</title>
    ...
    <div class="container">
        ...
        <div class="sidebar">
            <ul>
                ...
                <a href="./notreturned.php"><li class="active">List of Not Returned Books</li></a>
                <a href="./others/login.php"><li>Logout</li></a>
            </ul>
        </div>

        <div class="main">
            <h2>List of Not Returned Books</h2>

            <div class="head">
                <!-- Search -->
                <form action="notreturnedResult.php" method="get">
                    <input type="text" name="search" id="">
                    <input type="submit" value="Search" id="search">
                </form>
                <a href="notreturned.php"><button class="addstudent">Refresh</button></a>
            </div>
            ...
            <table>
                ...
                <?php
                    ...
                    $search = $_GET['search'];
                    $sql = "SELECT * FROM list_of_borrowers_tbl WHERE firstname LIKE '$search%' || middlename LIKE '$search%' || lastname LIKE '$search%' || book_title LIKE '$search%' || due_date LIKE '$search%' || return_date LIKE '$search%' || borrower_id LIKE '$search%' ORDER BY borrower_id DESC";
